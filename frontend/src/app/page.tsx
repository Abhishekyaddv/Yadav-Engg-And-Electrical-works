...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-950 selection:bg-blue-500/30">
      ...
      {/* 1. HERO SECTION */}
      <section className="relative pt-16 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            {/* --- NEW: ESTABLISHED MARKER --- */}
            {/* Minimalist, technical font, tight spacing to avoid pushing content down */}
            <span className="font-mono text-[15px] md:text-xs font-bold tracking-[0.3em] text-slate-500 uppercase mb-3 select-none">
              — Est. 2005 —
            </span>

            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-900/30 border border-blue-800 text-blue-400 text-[10px] sm:text-xs font-bold tracking-widest uppercase mb-6 backdrop-blur-sm">
